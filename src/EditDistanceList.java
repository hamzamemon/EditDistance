...
/**
 * Class to do the Edit Distance algorithm based on an ArrayList
 */
public class EditDistanceList {
     ...
     */
    public EditDistanceList(String filename) {
        String word = "";
    ...
    public void printList(String start, String end, int steps) {
        ...
        if(ifPossible) {
            ...
            for(int i = 0, length = finalWords.size() - 1; i < length; i++) {
